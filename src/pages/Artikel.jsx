      ...
      <div className="w-full h-[200px] justify-center items-center" id="top">
          <div className="flex flex-row gap-5 p-40">
              <div className="w-full flex-1">
                  <input type="text" placeholder="Cari artikel yang ingin anda ingin baca" className="w-full input input-md bg-white border-none shadow-md" />
              </div>
      ...
      <div className="w-full flex justify-center">
        <div className="flex flex-col w-full py-10">
          <div className="w-full flex flex-col">
            <p className="font-bold text-3xl"><span className="text-[#0081C6]">Artikel</span> <span>Terbaru</span></p>
          </div>
          <div className="w-full mt-10">
            <CardListArtikel limit={4}/>
          </div>
          <div className="w-full mt-10 text-center">
            <button className="bg-[#0081C6] text-white text-xl h-10 w-60 rounded-md mt-20">Selengkapnya</button>
          </div>
        </div>
      </div>
      </div>
