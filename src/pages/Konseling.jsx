...
import CardListDokter from "../components/Cards/CardListDokter";
      ...
      <div className="w-full flex justify-center">
        <div className="flex flex-col w-full py-10">
          <div className="w-full flex flex-col">
            <p className="font-bold text-3xl"><span className="text-[#0081C6]"></span><span>Daftar Psikolog</span></p>
          </div>
          <div className="w-full mt-10">
            <CardListDokter limit={6}/>
          </div>
