    ...
    <div className="flex">
      {artikelData.slice(0, limit).map((data, index) => {
        return (
          ...
          >
            <img className="w-full h-56 object-cover rounded-lg shadow-lg" src={data.image} alt="Placeholder" />
            <div className="px-1 py-1 rounded-tr-3xl top-1/2">
              <div className="font-bold text-gray-400 text-xl mt-3">{data.kategori}</div>
