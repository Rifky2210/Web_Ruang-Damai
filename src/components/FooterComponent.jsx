  ...
  return (
    ...
    <footer className="footer bg-[#D2F5FF] text-black p-10 mt-20">
      <div className="container mx-auto">
        <div className=" border-t border-white pt-5 grid grid-cols-1 md:grid-cols-3 gap-40 ">
          <div className="flex flex-col items-center md:items-center w-80">
          <div className="flex items-center mb-4 w-60">
              <img src="../images/logo.png" alt="Logo" className="w-full p-5 bg-white border-2 border-[#0081C6] mr-2 rounded-full"/>
          </div>
          </div>
          ...
          <div className="text-center md:text-left mt-10">
            ...
            <ol className="list-disc ml-4">
              <li><a href="/" className="hover:underline">Artikel Kesehatan Mental</a></li>
              <li><a href="/donasiku" className="hover:underline">Video - video</a></li>
              <li><a href="/tentang" className="hover:underline">Konseling</a></li>
              <li><a href="/berita" className="hover:underline">Chat Bot</a></li>
              <li><a href="/berita" className="hover:underline">Webinar</a></li>
            </ol>
          </div>
          <div className="text-center md:text-left mt-10">
      ...
      <div className="flex w-full h-20 bg-[#0081C6] justify-center items-center">
          <p className='text-center text-white'>Copyright © RuangDamai. 2024. All rights reserved.</p>
      </div>
    </div>
  );
};
